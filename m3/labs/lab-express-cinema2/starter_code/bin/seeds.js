...
Movie.create(movies)
.then(movies => {
  console.log("You created these movies", movies)
  mongoose.connect.close() // close the connection since you only needed this connection to create the original first 8 movies
})
.catch(err => {
